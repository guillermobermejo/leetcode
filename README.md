...
|---|---|---|---|---|---|---|
|Longest Word<br/>*(Regex Simplified)*|[LongestWord3.java](https://github.com/guillermobermejo/leetcode/blob/main/x-coderbyte/LongestWord3.java)|[x-coderbyte](https://github.com/guillermobermejo/leetcode/tree/main/x-coderbyte)|Easy|Java|42.3% higher|N/A|
|---|---|---|---|---|---|---|
|Longest Word<br/>*(Regex Simplified+)*|[LongestWord4.java](https://github.com/guillermobermejo/leetcode/blob/main/x-coderbyte/LongestWord4.java)|[x-coderbyte](https://github.com/guillermobermejo/leetcode/tree/main/x-coderbyte)|Easy|Java|42.3% higher|N/A|
