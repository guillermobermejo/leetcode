...
Algorithm:
    ...
    while loop: (fast != null)
        ...
        increment pointers:
            ...
            move fast by 1: fast = fast.next    // fast will move by 1 below
            
        if check: 
            if fast is now null
                return false as linked list ended
            
            increment fast:
                move fast by 1: fast = fast.next    // fast is not null so move it by 1 to move total to 2
