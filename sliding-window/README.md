# leetcode/sliding-window :space_invader:	:space_invader:	:space_invader:	
...
|[Permutation In String](https://leetcode.com/problems/permutation-in-string/)|[checkInclusion.java](https://github.com/guillermobermejo/leetcode/blob/main/sliding-window/checkInclusion.java)|Medium<br/>*Cracked*|Java|O(n)|O(n)|5ms<br/>(Beats 96.67%)|42.1mb<br/>(Beats 95.22%)|
