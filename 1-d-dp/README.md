# leetcode/1-d-dp :space_invader:	:space_invader:	:space_invader:	
...
|---|---|---|---|---|---|---|---|
|House Robber II<br/>*(modular +)*|robCircular2.java|Medium|Java|O(n)|O(1)|0ms (Beats 100%)|40.8mb (Beats 43.49%)|
|---|---|---|---|---|---|---|---|
